...
public class DimensionalSlashRenderer extends EntityRenderer<DimensionalSlashProjectile> {

    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(
                    EOPMod.MOD_ID,
                    "textures/entity/projectile/dimensional_slash_0.png"
            );
    ...
    @Override
    public void render(
            DimensionalSlashProjectile entity,
            float entityYaw,
            float partialTicks,
            PoseStack poseStack,
    ...
    @Override
    public ResourceLocation getTextureLocation(DimensionalSlashProjectile entity) {
        return TEXTURE;
    }
}