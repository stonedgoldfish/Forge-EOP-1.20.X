...
public class NoNaturalRegenAbility extends Ability {
    ...
    public static final PalladiumProperty<Boolean> REMOVE_HUNGER_BAR = new BooleanProperty("remove_hunger_bar").configurable("If true, keeps the player's hunger full and hides the hunger bar.");
    ...
    public String getDocumentationDescription() {
        return "Disables natural regeneration";
    }
}