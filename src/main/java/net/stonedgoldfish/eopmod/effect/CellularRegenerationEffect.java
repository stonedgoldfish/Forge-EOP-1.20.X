...
public class CellularRegenerationEffect extends MobEffect {

    public CellularRegenerationEffect() {
    ...
    public void applyEffectTick(LivingEntity entity, int amplifier) {
        ...
        entity.getServer().getCommands().performPrefixedCommand(
                ...
                "superpower add eop:mob_effects/cellular_reconstruction " + selector
        );
    }
    ...
    public void removeAttributeModifiers(
        ...
        entity.getServer().getCommands().performPrefixedCommand(
                entity.createCommandSourceStack().withSuppressedOutput().withPermission(2),
                "superpower remove eop:mob_effects/cellular_reconstruction " + selector
        );
    }
}