...
public class ArgonShovelItem extends ShovelItem {
    public ArgonShovelItem(Tier tier, float attackDamageModifier, float attackSpeedModifier, Properties properties) {
